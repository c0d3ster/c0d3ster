...
export const CompactUserProfile = () => {
  ...
  if (!isLoaded || isLoading || !clerkUser) {
    return (
      <div className='flex animate-pulse flex-col items-center space-y-3 sm:flex-row sm:items-center sm:space-y-0 sm:space-x-4'>
        <div className='size-12 rounded-full bg-green-400/20'></div>
  ...
  return (
    <div className='flex flex-col items-center space-y-3 sm:flex-row sm:items-center sm:space-y-0 sm:space-x-4'>
      {/* Avatar */}
      <div className='relative size-12 overflow-hidden rounded-full border-2 border-green-400/30 sm:size-12'>
        {clerkUser.imageUrl ? (
          <Image
          ...
          <div className='flex size-full items-center justify-center bg-green-400/20 font-mono text-lg font-bold text-green-400'>
