...
export const ProjectFileUpload = ({
  ...
  const resetSelection = () => {
    ...
    setCaption('')
    setPlacement(FilePlacement.Gallery)
  ...
  return (
    <div className='space-y-4'>
      ...
      {selectedFile && (
        <>
          <p className='truncate font-mono text-sm text-green-300'>
            {selectedFile.name}
          </p>
          ...
          <div className='flex justify-center'>
            <button
              ...
              disabled={isUploading}
              className='rounded border border-green-400/30 bg-green-400/10 px-4 py-2 font-mono text-sm text-green-400 hover:bg-green-400 hover:text-black disabled:opacity-50'
            >
