...
export async function generateMetadata(_props: IBallzProps): Promise<Metadata> {
  return {
...
export default async function Ballz(props: IBallzProps) {
        ...
        <ScrollFade>
          <div className='mx-auto max-w-4xl space-y-12'>
              ...
              <div className='grid gap-4 md:grid-cols-2'>
                <div className='rounded border border-green-400/20 bg-black/40 p-6'>
                  ...
                  <p className='font-mono text-sm text-green-300 opacity-80'>
                    Advanced rendering with dynamic lighting and particle
                    effects
                  </p>
                </div>
                <div className='rounded border border-green-400/20 bg-black/40 p-6'>
            ...
            <div className='text-center font-mono text-sm text-green-600 opacity-40'>
              ...
              <p>
                <TypewriterEffect
                  text='DEVELOPMENT TIME: 8 MONTHS'
                  speed={65}
                />
              </p>
              <p>
